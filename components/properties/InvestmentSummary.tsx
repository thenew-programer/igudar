      ...
      <Card className="sticky top-6 shadow-lg rounded-2xl border-0">
        ...
        <CardContent className="space-y-8 px-6 pb-6 pt-2 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-igudar-text text-base">Investment Calculator</h4>
            <div className="space-y-2">
              ...
              <Input
                ...
                className="text-right border-2 border-igudar-primary/20 focus:border-igudar-primary rounded-lg"
