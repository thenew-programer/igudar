                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-igudar-text-muted mb-2">
                                  {property?.city || 'Unknown'} • {investment.shares_purchased} shares
                                </p>
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="bg-white border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-igudar-text-secondary">Total Shares</span>
                      <span className="font-semibold text-igudar-text">
                        {portfolioSummary.total_shares.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
